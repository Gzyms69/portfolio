    ...
    <>
      ...
      <div className="fixed left-8 top-8 z-[110] hidden sm:block">
        <Magnetic strength={0.3}>
          ...
          >
            <Settings className={`h-6 w-6 transition-all duration-500 ${isMenuOpen ? 'rotate-90 text-primary' : 'animate-[spin_10s_linear_infinite] text-primary/40 hover:text-primary'}`} />
